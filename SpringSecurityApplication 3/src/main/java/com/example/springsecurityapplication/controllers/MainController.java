        ...
        if(!ot.isEmpty() & !Do.isEmpty()) {
            ...
            if (!price.isEmpty()) {
                ...
                if (price.equals("sorted_by_ascending_price")) {
                    ...
                    if (!category.isEmpty()) {
                        // Если категория равна рефракторы
                        if (category.equals("refractor")) {
                            ...
                            // Если категория равна рефлекторы
                        } else if (category.equals("reflector")) {
                            ...
                            // Если категория равна линзы
                        } else if (category.equals("lenses")) {
